...
namespace Zi.LinqSqlLayer.DAOs.Interfaces
{
    ...
    {
        /// <summary>
        /// This method retrieves categories from the category table.
        ...
        /// <para>+ Item1 = true => Item2 = Paginator<CategoryModel>(a list containing at least one CategoryModel object).</para>
        ...
        /// <summary>
        /// This method saves a new category to the category table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any.</para>
        /// <para>+ Item1 = true => Item2 = CategoryId (là Guid của category vừa được lưu).</para>
        ...
        /// <summary>
        /// This method updates the data of a category that exists in the category table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any.</para>
        ...
        /// <summary>
        /// This method remove a category that exists in the category table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any. </para>
