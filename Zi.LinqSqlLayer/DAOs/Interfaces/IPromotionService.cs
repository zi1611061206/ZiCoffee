...
namespace Zi.LinqSqlLayer.DAOs.Interfaces
{
    ...
    {
        /// <summary>
        /// This method retrieves promotions from the promotion table.
        ...
        /// <para>+ Item1 = true => Item2 = Paginator<PromotionModel>(a list containing at least one PromotionModel object).</para>
        ...
        /// <summary>
        /// This method saves a new promotion to the promotion table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any.</para>
        /// <para>+ Item1 = true => Item2 = PromotionId (là Guid của promotion vừa được lưu).</para>
        ...
        /// <summary>
        /// This method updates the data of a promotion that exists in the promotion table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any.</para>
        ...
        /// <summary>
        /// This method remove a promotion that exists in the promotion table.
        /// <para>RETURNS</para>
        /// <para>The method returns a tuple of 2 items:</para>
        /// <para>- Item1 (bool) indicates the data query execution result.</para>
        /// <para>- Item2 (object) contains the return data if any. </para>
