...
namespace Zi.ZiCoffee.Engines.Theme
{
    public class LightTheme
    {
        ...
        public LightTheme()
        {
            MainBack = Color.FromArgb(217, 217, 217);
            HFBack = Color.FromArgb(230, 230, 230);
            ...
            ButtonBackNavHover = Color.FromArgb(255, 153, 0);
            ButtonBackBlueHover = Color.FromArgb(0, 168, 255);
            DisabledBack = Color.Gray;
            WinStateBack = Color.FromArgb(191, 191, 191);
